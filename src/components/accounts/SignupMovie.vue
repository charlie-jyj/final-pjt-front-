<template>
     <div class="card d-flex flex-row row" style="height: 10rem;">
      ...
      <img class="card-img-top ms-1" :src="movie.poster_path" alt="Card image cap" style='height: 100%; width: 100%; object-fit: contain'>
      </div>
      <div class="card-body col-9">
        <div class="ms-2">
          <h5 class="card-title mt-2 fw-bold">{{movie.title}}</h5>
